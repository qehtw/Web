...
export const ItemsProvider = ({ children }) => {
  const [items, setItems] = useState([
    ...
    },
    {
      ...
      name: "КУКУРУДЗА",
      price: 2.5,
      description:"Ця банка кукурузи була названа в честь нашого Гетьман і ікони цього сайту, що означає любий хто з'їсть її отримає силу яку неможливо отримати власними силами. Ходять плітки що плітки почали ходити бо з'їли кукурудзи, а також, в неї є брат якого звати горошок. Їх обох назвали в честь найкращих людей нашого століття ",
      category: "Fruits",
